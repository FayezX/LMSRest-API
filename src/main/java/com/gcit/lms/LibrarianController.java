...
public class LibrarianController {
	...
	@RequestMapping(value = "/LibrariansMenu", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/LibrarianCopies", method = RequestMethod.PUT, consumes="application/json", produces="application/json")
	public void changeCopyOfBook(){
		
	}
	
	@RequestMapping(value = "/LibrarianCopies", method = RequestMethod.GET,produces="application/json")
